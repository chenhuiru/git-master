...
// function getFl(url,obj,obj2) {
//     $.ajax({
//         type: "post",
//         dataType: "json",
//         url: url,
//         success: function (data) {
//             var datas = data.productSort;
//             console.log(datas[obj2])
//             var str = ''
//             var len = datas[obj2].length;
//             if (datas != "") {
//
//                 for (let i = 0; i < len; i++) {
//                     str += `<span>${datas[obj2][i]}</span>`
//                 }
//                 obj.html(str);
//                 // alert(123)
//                 console.log(str,obj)
...
// }
    ...
    router.route('/', function() {
        getUrl({html:"pages/product/pages/index.html"},obj);
    });
    router.route('/shafa', function() {
        getUrl({html:"pages/product/pages/shafa.html"},obj);

    });
    router.route('/dask', function() {
        getUrl({html:"pages/product/pages/dask.html"},obj);

    });
    router.route('/bad', function() {
        getUrl({html:"pages/product/pages/bad.html"},obj);


    });
    router.route('/storage', function() {
        getUrl({html:"pages/product/pages/storage.html"},obj);


    });
    router.route('/more', function() {
        getUrl({html:"pages/product/pages/more.html"},obj);
